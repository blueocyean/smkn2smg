    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <!-- BEGIN NAVBAR LOGO --><a href="." class="navbar-brand navbar-brand-autodark"><svg xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68" class="navbar-brand-image">
          ...
          <div class="card-body">
            ...
            <form action="./" method="get" autocomplete="off" novalidate="">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name='identifier' placeholder="123">
              </div>
              <div class="mb-2">
